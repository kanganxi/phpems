...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar = [
		...
		{ name: 'insert', items: [ 'Image','imgur', 'Mathjax', 'Table', 'HorizontalRule', 'SpecialChar','music','video'] },
	...
	config.extraPlugins = 'mathjax,music,preview,font,colorbutton,justify,wikititle,lineheight,video,imgur';
	...
	CKEDITOR.config.contentsCss = ['files/public/css/bootstrap.css','files/public/css/jquery-ui.min.css','files/public/css/pe.master.css','files/public/js/ckeditor/ckeditor.css'];
};
