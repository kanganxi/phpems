									...
									<div class="intro">
										<div class="desc">
											<table class="table table-bordered">
												...
												<tr>
													<td>地址：</td>
													<td><input needle="needle" msg="请填写地址" type="text" placeholder="请填写地址" name="info[useraddress]" value="{x2;$_user['useraddress']}"></td>
													<td>联系电话：</td>
													<td><input needle="needle" mas="请填写联系电话" type="text" placeholder="请填写联系电话" name="info[userphone]" value="{x2;$_user['userphone']}"></td>
												</tr>
											</table>
										</div>
									</div>
