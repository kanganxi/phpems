			...
			<div class="col-xs-9 split pull-right" style="padding:0px;position:relative;">
				...
				<div class="box itembox paperexamcontent">
					<h4 class="title">
						...
						<span class="pull-right">
							<a class="btn btn-primary qicon" href="index.php?exam-teach-questions-modifyquestion&page=&questionid={x2;v:question['questionid']}"><i class="glyphicon glyphicon-edit"></i></a>
				...
				<div class="box itembox paperexamcontent">
					...
					<h4 class="title">
						第{x2;v:did}题
						<span class="pull-right">
							<a class="btn btn-primary qicon" href="index.php?exam-teach-rowsquestions-modifychildquestion&questionparent={x2;v:question['questionparent']}&questionid={x2;v:question['questionid']}"><i class="glyphicon glyphicon-edit"></i></a>
